...
//    content.contentDescription = self.description // commented from original
//    content.contentTitle = self.title // commented from original
//    content.imageURL = self.imageURL // commented from original
